...
public class OpenIntakeArms extends Command {
    ...
    protected void initialize() {
    	...
    	// If the intake arms are already open, this command is finished.
    	if(Robot.intake.areArmsOpen())
    		isCommandFinished = true;
    	
    	// If the intake arms are closed, open them.
    	else
    ...
    protected void execute() {
    	...
    	// If the intake arms are open, this command is finished.
    	if(Robot.intake.areArmsOpen())
    		isCommandFinished = true;
    }
